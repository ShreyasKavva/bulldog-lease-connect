...
export function timeAgo(iso: string): string {
  ...
  // Q185 — never fall back to a raw date; keep it relative.
...
/**
 * Q101 C1 — human relative time for "Posted X ago" on listing cards.
 * Unlike timeAgo() this never falls back to an absolute date.
 */
