  ...
  return (
    <div className="mx-auto max-w-7xl px-0 md:px-6 lg:px-10">
      <div className="flex min-h-[calc(100vh-3.5rem)] md:gap-6 md:py-6">
        ...
        >
          <h1 data-dbg={`${tab}|${currentTab}|${inqUnread}|${sentUnread}|${inquiries.length}|${sent.length}`} className="px-4 pb-2 pt-5 text-2xl font-bold tracking-tight md:text-xl">Messages</h1>
